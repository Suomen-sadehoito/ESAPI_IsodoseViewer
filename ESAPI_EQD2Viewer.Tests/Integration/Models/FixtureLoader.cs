...
{
    /// <summary>
    /// Loads JSON test fixtures from disk. Discovers fixture directories
    /// and deserializes them into strongly-typed models.
    /// 
    ...
    public static class FixtureLoader
    {
        ...
        /// Searches upward from the test output directory to find the project root.
        /// </summary>
